...
class WhiteFoxStudios_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'white-fox-studios'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'white-fox-studios'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'white-fox-studios'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'white-fox-studios'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'white-fox-studios');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'white-fox-studios'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'white-fox-studios');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'white-fox-studios'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'white-fox-studios') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'white-fox-studios');
            case 'false':
                return __('false', 'white-fox-studios');

            case 'Administrator':
                return __('Administrator', 'white-fox-studios');
            case 'Editor':
                return __('Editor', 'white-fox-studios');
            case 'Author':
                return __('Author', 'white-fox-studios');
            case 'Contributor':
                return __('Contributor', 'white-fox-studios');
            case 'Subscriber':
                return __('Subscriber', 'white-fox-studios');
            case 'Anyone':
                return __('Anyone', 'white-fox-studios');
        }
        return $optionValue;
    }
